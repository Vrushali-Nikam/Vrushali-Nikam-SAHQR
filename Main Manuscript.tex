...
*Corresponding author(s). E-mail(s): \href{vrushali.nikam@ges-coengg.org}{vrushali.nikam@ges-coengg.org};{smita.singh@siu.edu.in}\\
...
\section*{Consent to Publish declaration}
Not Applicable.
...
\noindent\textbf{Data availability} The NIST-MNI medical imaging dataset\texttt{https://nist.mni.mcgill.ca/bite-brain-images-of-tumors-for-evaluation-database/} used in this study is publicly available from the Montreal Neurological Institute. The source code and processed datasets are available at \texttt{https://github.com/Vrushali-Nikam/Vrushali-Quantum-Image-Representation}.
